...
const NavbarMain = () => {
    ...
    return (
        ...
        w-full fixed left-[0px]  -translate-x-50% z-20 flex gap-4 mt-6'>
            ...
            <div className='flex lg:hidden sm:block p-6 bg-black rounded-full border-[0.5px] border-amber-400'>
                <button className='text-2xl border border-amber-400 p-3 rounded-full text-white cursor-pointer'
                 onClick={toggleMenu}>
                <GiHamburgerMenu />
